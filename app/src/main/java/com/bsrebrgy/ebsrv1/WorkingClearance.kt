...
class WorkingClearance : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_working_clearance)
    ...
    private fun loadCert() {
        val url = "http://www.barangaysanroqueantipolo.site/API/cert3Api.php"
