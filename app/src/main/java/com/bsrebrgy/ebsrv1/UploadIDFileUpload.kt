...
class UploadIDFileUpload : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        session = SessionManager(this@UploadIDFileUpload)
        session.checkLogin()
        ...
        validAdapter = ArrayAdapter<String>(this@UploadIDFileUpload,android.R.layout.simple_spinner_dropdown_item,vidStat)
